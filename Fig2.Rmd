...
source: https://github.com/VC2015/DMLonGitHub/blob/master/Figure2.m
...
png("Fig2_full.png")
hist(b1,breaks = edges,freq = FALSE,main="Full Sample",xlab = "")
x<-seq(-10,10,by=0.05)
curve(dnorm(x), add=TRUE,col="red")
dev.off() 
png("Fig2_split.png")
hist(b2,breaks = edges,freq = FALSE,main = "Sample Splitting",xlab = "")
curve(dnorm(x), add=TRUE,col="red")
dev.off() 
```
