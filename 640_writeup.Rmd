...
For the Table 3 and 4, we compared the effect of sample splitting under different combinations of sample size the number of covariates. We fix the variance for the error term be 0.01, coefficients for covariates follow normal distribution, and the outcome model be generated from linear functions
